    ...
    <div className="md:container md:mx-auto min-h-full ml-4 mr-4 pt-32 bg-teal-100">
      ...
      <div className="flex flex-row text-l text-center pt-8 pb-8 pl-10 pr-10">
        <div className="basis-1/4 md:basis-1/3">
          <Button btnStyles={btnStyle} title='Full Stack' onClick={()=>{}}></Button>
        </div>
        <div className="basis-1/4 md:basis-1/3">
          <Button btnStyles={btnStyle} title='Front End' onClick={()=>{}}></Button>
        </div>
        <div className="basis-1/2 md:basis-1/3">
          <Button btnStyles={btnStyle} title='Back End' onClick={()=>{}}></Button>
        </div>
      </div>
